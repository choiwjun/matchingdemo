                ...
                <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
                    ...
                    <div className="prose prose-gray max-w-none">
                        <p className="text-gray-600 mb-6">
                            ProMatch（以下「当社」といいます）は、当社が提供するサービス「ProMatch」（以下「本サービス」といいます）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。
                        </p>
                        ...
                        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第9条（Cookieの使用について）</h2>
                        <p className="text-gray-600 mb-4">
                            当社のウェブサイトでは、ユーザーの利便性向上のためCookieを使用しています。Cookieとは、ウェブサイトがユーザーのコンピュータのハードディスクに保存する小さなテキストファイルです。
                        </p>
                        <p className="text-gray-600 mb-4">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第10条（プライバシーポリシーの変更）</h2>
                        <p className="text-gray-600 mb-4">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg mb-4">
                            <p className="text-gray-700">
                                <strong>ProMatch運営事務局</strong><br />
                                メール: privacy@promatch.jp<br />
                                電話: 03-1234-5678<br />
                                受付時間: 平日 9:00〜18:00
                            </p>
                        </div>
