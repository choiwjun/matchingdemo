            ...
            <main className="container mx-auto px-4 py-8">
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">ご興味のある案件にご提案ください。</p>
                    </div>

                    {/* Filters */}
                    <div className="card">
                        <div className="flex flex-wrap gap-2">
                            <button className="btn btn-primary text-sm">すべて</button>
                            <button className="btn btn-secondary text-sm">建設・リフォーム</button>
                            <button className="btn btn-secondary text-sm">清掃・整理</button>
                            <button className="btn btn-secondary text-sm">引越し・運送</button>
                            <button className="btn btn-secondary text-sm">修理・設置</button>
                            <button className="btn btn-secondary text-sm">その他</button>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {projects.length === 0 && (
                            <div className="card text-center py-12">
                                ...
                                <p className="text-gray-500">現在募集中の案件がございません。</p>
                            </div>
                        )}
                    </div>
                </div>
